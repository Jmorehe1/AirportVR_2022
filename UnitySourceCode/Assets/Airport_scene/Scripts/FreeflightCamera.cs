...
public class FreeflightCamera : MonoBehaviour 
{
	...
	void FixedUpdate()
	{
        ...
        {
            float rotX = transform.localEulerAngles.y + Input.GetAxis("Mouse X") * mouseSensitivityX * sensitivityFactor;
            
            rotY = rotY + Input.GetAxis("Mouse Y") * mouseSensitivityY * sensitivityFactor;
